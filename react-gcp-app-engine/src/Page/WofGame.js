...
// initialization
    ...
    }, [numGuess, maxGuess, asterisks, phrase]); //re-run this useEffect when these states change
    //use input for guess
  ...
  // fetch user record
   const fetchUserRecord = () =>{
    ...
    const handleDeleteSelected = async () => {
      const confirmDelete = window.confirm("Are you sure you want to delete all game records?");
      try {
      ...
      <div className="hangman-container">
        ...
        <div className="game-info">
          <p className="info-text">
            Attendance: {numGuess}, Missed: {missGuess}, Chances left: {maxGuess - numGuess}
          </p>
